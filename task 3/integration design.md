I would implement a lightweight backend API between the landing page and third-party systems instead of using HubSpot embedded forms or no-code tools like Zapier. The flow would be:
